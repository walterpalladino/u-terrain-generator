...
public static class UTTerrainMaskUtils
{
    ...
    {
        float[,] maskData = UTTerrainMaskUtils.GenerateCircularMask(size, maskMarginOffset);
    ...
    {
        float[,] maskData = UTTerrainMaskUtils.GenerateSquareMask(size, maskMarginOffset);
        return ApplyMask(originalData, maskData, size);
    }
    ...
    {
        float[,] maskData = UTTerrainMaskUtils.GenerateCustomMask(size, maskMarginOffset, terrainCurve);
        return ApplyMask(originalData, maskData, size);
    }
